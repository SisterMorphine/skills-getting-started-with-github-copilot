...
activities = {
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions in various scientific disciplines",
    ...
    "Drama Club": {
        "description": "Participate in theatrical productions and performance workshops",
